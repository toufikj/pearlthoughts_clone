...
inputs = {
  ...
  # codedeploy_role_arn   = "arn:aws:iam::607700977843:role/CodeDeployECSBlueGreen"
  # ssl_certificate_arn = ""
...
terraform {
  source = "${get_parent_terragrunt_dir("root")}}/../modules/aws/ecs-code-deploy"  # Correct relative path to the Strapi module
}
